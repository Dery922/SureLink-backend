 ...
 *
 * Single-step login — no OTP 2FA. The session is created immediately once
 * the password is verified and { admin, session } is returned.
 */
export async function loginAdmin({ email, password, ip, user_agent }) {
  ...
  // Password correct — record login and create the session.
