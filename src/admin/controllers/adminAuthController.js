 ...
 *
 * Login is single-step: POST /login validates credentials and, on success,
 * returns the admin profile + session token directly.
 */
...
/**
 * Login.
 * Validates email + password. On success, creates a session and returns the
 * admin profile + session token. The client stores the token and uses it as a
