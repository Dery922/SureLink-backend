...
// Registered as "ProviderBooking" (collection: provider_bookings) to coexist
// with the admin dashboard's canonical "Booking" model, which has a different
// schema shape and uses the "bookings" collection.
export default mongoose.model("ProviderBooking", bookingSchema, "provider_bookings");
